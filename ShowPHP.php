...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitTryit()
        {
            ...
            xmlhttp.open('POST', 'TryPHPFileWork.php', false);
    ...
    <div class="textareacontainer">
        <form class="textarea">
            <div style="overflow:auto;">
                <div class="headerText">Редактируйте этот код:</div>
        ...
        <textarea autocomplete="off" class="code_input" id="textareaCode" wrap="logical" spellcheck="false"><?php
            if (isset($_GET['filename'])) {
                $fName =  "./TryPHP/UserTries/" . $_SESSION['uid'] . $_GET['filename'] . ".php";
                if (!file_exists($fName)) {
                    $fName = './TryPHP/' . $_GET['filename'] . '.php';
                }
