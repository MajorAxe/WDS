...
if(regnew($user,$pass,$nick,$mail)) {
    ...
    В будущем в этой области будут появлятся новые. Сообщения от обычных пользователей выделены зелёным. Вы можете отметить любое сообщение как прочитанное, кликнув по нему.
